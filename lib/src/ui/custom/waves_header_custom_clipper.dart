...
class WavesHeaderCustomClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    var firstControlPoint = Offset(size.width * 0.10, size.height * 0.10);
    var firstEndPoint = Offset(size.width * 0.15, size.height * 0.45);

    path.quadraticBezierTo(firstControlPoint.dx, firstControlPoint.dy,
        firstEndPoint.dx, firstEndPoint.dy);

    var secondControlPoint = Offset(size.width * 0.25, size.height * 0.95);
